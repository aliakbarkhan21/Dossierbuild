...
TEMPLATES: dict[str, Template] = {
    ...
    "boardroom": Template(
        key="boardroom",
        name="Boardroom",
        blurb="Name set large over a rule, two columns divided by a hairline, no colour.",
        file="boardroom.html.j2",
        ats=False,
        columns="Two columns",
        best_for="Consulting, law and senior management, where colour reads as a bought template.",
        photo=True,
    ),
    "atelier": Template(
        key="atelier",
        name="Atelier",
        blurb="Tracked name between two rules, even columns, a disc behind each heading.",
        file="atelier.html.j2",
        ats=False,
        columns="Two columns",
        best_for="Early careers, where the qualifications are the argument.",
        photo=True,
    ),
    "editorial": Template(
        key="editorial",
